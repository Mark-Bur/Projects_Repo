...
| [Определение тональности текста](text_classification) |Проект по машинному обучению для текстов, направленный на определение тональности отзывов пользователей.|*pandas, numpy, sklearn, transformers, pytorch*|